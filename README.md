...
A tank arena game in the TankArena repository using Unity assets and the xNodeUtilityAI framework in order to create an AI tournament among my students :
